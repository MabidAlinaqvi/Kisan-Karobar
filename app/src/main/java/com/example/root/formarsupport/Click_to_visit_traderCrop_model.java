...
public class Click_to_visit_traderCrop_model {
    private String product_name, city, TEHSIL, DISTT, Sack_price, quantity, latitude, longitude;

    public Click_to_visit_traderCrop_model() {

    }

    public Click_to_visit_traderCrop_model(String product_name, String city, String TEHSIL, String DISTT, String sack_price, String quantity, String latitude, String longitude) {
