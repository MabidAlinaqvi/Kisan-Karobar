...
public class Trader_crop_click_Own_listItem extends Fragment implements View.OnClickListener {
    View view;
    ...
    Marker marker = null;
    static Double t_latiLogin, t_logiLogin;
    static String Choose;
    Uri photoUri;
    EditText name, ntnNum, product, type, city, tehsil, distric, sackprice, productquant;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_trader_crop_click__own_list_item, container, false);
        gettingIds();
        MakeEditable();
...
/**
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                if (ActivityCompat.checkSelfPermission(getActivity(),
                    ...
                    if (location != null) {
                        t_latiLogin = location.getLatitude();
                        t_logiLogin = location.getLongitude();
                    ...
                    LatLng selected = new LatLng(t_latiLogin, t_logiLogin);
                    if (marker != null) {
                        marker.remove();
                    }
    ...
    private void MakeEditable() {
        name.setOnClickListener(Trader_crop_click_Own_listItem.this);
        PersonCamera.setOnClickListener(Trader_crop_click_Own_listItem.this);
        ntnNum.setOnClickListener(Trader_crop_click_Own_listItem.this);
        product.setOnClickListener(Trader_crop_click_Own_listItem.this);
        type.setOnClickListener(Trader_crop_click_Own_listItem.this);
        city.setOnClickListener(Trader_crop_click_Own_listItem.this);
        tehsil.setOnClickListener(Trader_crop_click_Own_listItem.this);
        distric.setOnClickListener(Trader_crop_click_Own_listItem.this);
        sackprice.setOnClickListener(Trader_crop_click_Own_listItem.this);
        productquant.setOnClickListener(Trader_crop_click_Own_listItem.this);
    }
